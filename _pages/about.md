...
<div style="font-family: Georgia, serif; text-align: justify;">
  ...
  <div style="margin-top: 14px; background:#f7f2e7; padding:16px 20px; border-left:6px solid #8c6d3a; border-radius:6px; font-family:Georgia, serif; font-size:15.5px; color:#4a3b2a;">
    <strong>This is my Automemoriomathography and for improved readability, it is recommended to view this page in Light Mode.</strong>
  </div>
...
<div style="border: 1px solid #7f8c8d; background: #f0f7f0; padding: 12px 16px; margin: 20px 0; font-family: 'Calibri', Georgia, serif; box-shadow: 0 0 0 1px #e0e0e0; border-radius: 0px;">
  ...
  <p style="font-family: Georgia, serif; color: #0b6623;"><strong>It's a long story but I didn't choose mathematics. Mathematics somehow adjusted with me and so far, neither of us has walked away.</strong> (nonsense apart:)</p>
